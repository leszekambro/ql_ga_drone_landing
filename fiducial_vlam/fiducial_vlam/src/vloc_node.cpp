#define ROS_CAMERA_IMAGE_TOPIC "/drone1/bottom/image_raw"
#define ROS_CAMERA_INFO_TOPIC "/drone1/bottom/camera_info"
//#define ROS_CAMERA_IMAGE_TOPIC "/image_raw"
//#define ROS_CAMERA_INFO_TOPIC "/camera_info"
#include <iomanip>
  ...
  public:
      ...
      : Node("vloc_node", options), cxt_{*this}
    {
      ...
      auto image_raw_qos = cxt_.sub_image_raw_best_effort_not_reliable_ ?
                             rclcpp::QoS{rclcpp::SensorDataQoS(rclcpp::KeepLast(1000))} :
                             rclcpp::QoS{rclcpp::ServicesQoS()};
      image_raw_sub_ = create_subscription<sensor_msgs::msg::Image>(
        ROS_CAMERA_IMAGE_TOPIC,
        image_raw_qos,
